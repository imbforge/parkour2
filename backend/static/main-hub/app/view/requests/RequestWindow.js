                ...
                },
                {
                  ...
                  listeners: {
                    change: function (cb) {
                      ...
                      var requestFormFieldValues = requestForm
                        .getForm()
                        .getFieldValues();
                      var requestRecord = requestForm.up("window").record;
                      var requestId = requestRecord
                        ? requestRecord.get("pk")
                        : 0;
                ...
                },
                {
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      fieldLabel:
                        '<span data-qtip="Pool concentration">ng/μl</span>',
                    ...
                    },
                    {
                      ...
                      fieldLabel:
                        '<span data-qtip="Avg. pool size in bp">bp</span>',
                      // emptyText: 'Mean Size',
                      disabled: true,
                      labelWidth: 20,
                      width: 107,
      ...
      items: [
        {
          ...
          width: 310,
          fieldLabel:
            '<span style="padding-right:18px; font-style: italic">Internal use</span><span data-qtip="The GCF staff member responsible for handling the project. Optional.">Handler</span>',
        ...
        },
        {
          ...
          anchor: "100%",
          fieldLabel:
            '<span data-qtip="Automatically set to the date of sequencing when adding the request to a flowcell. Can be overridden here.">Invoice date</span>',
          format: "d.m.Y",
          name: "invoice-date",
          itemId: "invoice-date",
